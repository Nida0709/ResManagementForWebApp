...
def table():
    ...
    col = ['name', 'tell', 'date', 'n_hon', 'n_kin', 'res1', 'n_res1', \
        'res2', 'n_res2', 'res3', 'n_res3', 'res4', 'n_res4', 'res5', 'n_res5', 'other']
...
def register():
    ...
    con.execute("INSERT INTO reserves VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", \
        [name, str_tel, uni_date, n_hon, n_kin, res1, n_res1, res2, n_res2, res3, n_res3, res4, n_res4, res5, n_res5, other])
    con.commit()
    con.close()
